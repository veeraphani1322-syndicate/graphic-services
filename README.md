<p align="center">
  <img src="res/logo-header.svg" alt="Graphic Services remote desktop"><br>
...
Graphic Services is a branded remote-desktop client derived from
[RustDesk](https://github.com/rustdesk/rustdesk). The fork retains RustDesk's
cross-platform remote-control engine while using Graphic Services as the
user-facing product identity.

This project is licensed under the GNU Affero General Public License v3.0.
RustDesk remains a trademark and project of its respective owners; this fork
is independently branded and is not presented as an official RustDesk build.
See [BRANDING.md](BRANDING.md) for the branding boundary and upstream-sync
workflow.
