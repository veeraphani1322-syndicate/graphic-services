...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Graphic Services network..."),
        ...
        ("install_tip", "Windows UAC can limit remote control while Graphic Services is running in portable mode. Install Graphic Services to enable elevated and background access."),
        ("config_acc", "To control your desktop remotely, grant Graphic Services Accessibility permission."),
        ("config_screen", "To access your desktop remotely, grant Graphic Services Screen Recording permission."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Graphic Services to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Graphic Services Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Graphic Services application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Graphic Services \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Graphic Services \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Graphic Services."),
        ...
        ("View Mode", "View mode"),
        ("verify_rustdesk_password_tip", "Verify Graphic Services password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Graphic Services and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Graphic Services Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Graphic Services from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if the Graphic Services window is open"),
        ...
        ("floating_window_tip", "Keeps the Graphic Services background service running"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Graphic Services client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Graphic Services verifies the server certificate for protocols using TLS.\nWith this option enabled, Graphic Services will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Graphic Services will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Graphic Services server OSS doesn't include this feature."),
